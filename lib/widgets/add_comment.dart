...
class AddCommentState extends State<AddComment> {
  ...
  void _didSelectSend(BuildContext context) {
      addComment(_commentController.text, widget._lesson.id);
            ...
            child: Column(
              children: [
                Padding(
                  ...
                  child: TextField(maxLines: (300/ 20).toInt(), controller: _commentController, decoration: InputDecoration(focusedBorder: UnderlineInputBorder(borderSide: BorderSide(color: Colors.grey[200]!)), hintText: 'Enter your comment', hintStyle: TextStyle(color: Colors.grey[200])), cursorColor: Colors.grey[200], style: TextStyle(color: Colors.grey[200])),
                ),
                Padding(
                  padding: const EdgeInsets.all(10.0),
                  child: 
